...
const store = configureStore({
  ...
  }).concat(middleware, loggerMiddleware, asyncMiddlewareEx3, thunk, sagaMiddleware), // указываем через запятую ex1, ex2, ex3...
});
...
//     data: dataReducer,
//   },
//   middleware: (getDefaultMiddleware) => getDefaultMiddleware().concat(middleware, loggerMiddleware, asyncMiddlewareEx3, thunk, sagaMiddleware), // указываем через запятую ex1, ex2, ex3...
// });
